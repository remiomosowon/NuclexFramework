...
namespace Nuclex.UserInterface.Visuals.Flat.Renderers {
  ...
  public abstract class ControlRendererTest {
    ...
    public virtual void Setup() {
      ...
      this.mockedGraphics = this.mockery.CreateMock<IFlatGuiGraphics>();
    ...
    protected Mock<IFlatGuiGraphics> MockedGraphics {
    ...
    private Mock<IFlatGuiGraphics> mockedGraphics;
