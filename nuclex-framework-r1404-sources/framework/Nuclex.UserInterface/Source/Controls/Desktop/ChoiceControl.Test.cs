...
namespace Nuclex.UserInterface.Controls.Desktop {
  ...
  internal class ChoiceControlTest {
    ...
    public void TestToggleChoicesByMouse() {
      ...
      Mock<IChoiceSubscriber> mockedSubscriber1 = mockSubscriber(this.child1);
      Mock<IChoiceSubscriber> mockedSubscriber2 = mockSubscriber(this.child2);

      mockedSubscriber1.Expects.One.Method(m => m.Changed(null, null)).WithAnyArguments();
      mockedSubscriber2.Expects.One.Method(m => m.Changed(null, null)).WithAnyArguments();
    ...
    public void TestLastSecondAbortByMouse() {
      ...
      mockedSubscriber1.Expects.No.Method(m => m.Changed(null, null)).WithAnyArguments();
      mockedSubscriber2.Expects.No.Method(m => m.Changed(null, null)).WithAnyArguments();
