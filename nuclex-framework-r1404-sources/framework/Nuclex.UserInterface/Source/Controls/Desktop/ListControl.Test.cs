  ...
  internal class ListControlTest {
    ...
    public void TestSelectionChangedEvent() {
      using(MockFactory mockery = new MockFactory()) {
        ...
        Mock<IListSubscriber> mockedSubscriber = mockSubscriber(mockery, list);
    ...
    private static Mock<IListSubscriber> mockSubscriber(MockFactory mockery, ListControl list) {
      Mock<IListSubscriber> mockedSubscriber = mockery.CreateMock<IListSubscriber>();
