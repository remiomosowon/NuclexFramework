...
namespace Nuclex { namespace Fonts { namespace Content {
  ...
  /// </remarks>
  [System::Serializable]
  public ref class OutOfSpaceException : System::ApplicationException {
    ...
    public: OutOfSpaceException(System::String ^message) :
      System::ApplicationException(message) { }

    /// <summary>Initializes the exception as a followup exception</summary>
    /// <param name="message">Error message describing the cause of the exception</param>
    /// <param name="inner">Preceding exception that has caused this exception</param>
    public: OutOfSpaceException(System::String ^message, System::Exception ^inner) :
