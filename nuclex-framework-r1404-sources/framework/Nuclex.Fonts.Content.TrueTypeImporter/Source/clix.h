...
namespace clix {
  ...
  /* All this template stuff might seem like overkill, but it is well thought out and enables you
     to use a readable and convenient call while still keeping the highest possible code
  ...
  */
  ...
  // clix::marshalString()
  // ------------------------------------------------------------------------------------------- //
  /// Marshals strings between .NET managed and C++ native
  /** This all-in-one function marshals native C++ strings to .NET strings and vice versa.
      ...
      @param  string  String to be marshalled to the other side
      @return The marshaled representation of the string
  */
  template<Encoding encoding, typename SourceType>
