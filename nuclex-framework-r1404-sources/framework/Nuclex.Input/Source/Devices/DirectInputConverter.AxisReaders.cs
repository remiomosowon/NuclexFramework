...
namespace Nuclex.Input.Devices {
  ...
  partial class DirectInputConverter {
    ...
    private class XAxisReader : AxisReader {
      ...
      protected override int Read(ref JoystickState state) { return state.X; }
    }
    private class YAxisReader : AxisReader {
      public YAxisReader(int min, int max) : base(min, max) { }
      protected override int Read(ref JoystickState state) { return state.Y; }
    }
    ...
    private class VelocityXAxisReader : AxisReader {
      ...
      protected override int Read(ref JoystickState state) { return state.VelocityX; }
    }
    ...
    private class VelocityZAxisReader : AxisReader {
      ...
      protected override int Read(ref JoystickState state) { return state.VelocityZ; }
    }
    ...
    private class AccelerationXAxisReader : AxisReader {
      ...
      protected override int Read(ref JoystickState state) { return state.AccelerationX; }
    }
    ...
    private class AccelerationZAxisReader : AxisReader {
      ...
      protected override int Read(ref JoystickState state) { return state.AccelerationZ; }
    }
    ...
    private class ForceXAxisReader : AxisReader {
      ...
      protected override int Read(ref JoystickState state) { return state.ForceX; }
    }
    private class ForceYAxisReader : AxisReader {
      public ForceYAxisReader(int min, int max) : base(min, max) { }
      protected override int Read(ref JoystickState state) { return state.ForceY; }
    }
    private class ForceZAxisReader : AxisReader {
      public ForceZAxisReader(int min, int max) : base(min, max) { }
      protected override int Read(ref JoystickState state) { return state.ForceZ; }
    }
    ...
    private class RotationXAxisReader : AxisReader {
      ...
      protected override int Read(ref JoystickState state) { return state.RotationX; }
    }
    private class RotationYAxisReader : AxisReader {
      public RotationYAxisReader(int min, int max) : base(min, max) { }
      protected override int Read(ref JoystickState state) { return state.RotationY; }
    }
    private class RotationZAxisReader : AxisReader {
      public RotationZAxisReader(int min, int max) : base(min, max) { }
      protected override int Read(ref JoystickState state) { return state.RotationZ; }
    }
    ...
    private class AngularVelocityXAxisReader : AxisReader {
      ...
      protected override int Read(ref JoystickState state) { return state.AngularVelocityX; }
    }
    private class AngularVelocityYAxisReader : AxisReader {
      public AngularVelocityYAxisReader(int min, int max) : base(min, max) { }
      protected override int Read(ref JoystickState state) { return state.AngularVelocityY; }
    }
    ...
    private class AngularAccelerationXAxisReader : AxisReader {
      ...
      protected override int Read(ref JoystickState state) { return state.AngularAccelerationX; }
    }
    private class AngularAccelerationYAxisReader : AxisReader {
      ...
      protected override int Read(ref JoystickState state) { return state.AngularAccelerationY; }
    }
    private class AngularAccelerationZAxisReader : AxisReader {
      ...
      protected override int Read(ref JoystickState state) { return state.AngularAccelerationZ; }
    }
    ...
    private class TorqueXAxisReader : AxisReader {
      ...
      protected override int Read(ref JoystickState state) { return state.TorqueX; }
    }
    private class TorqueYAxisReader : AxisReader {
      public TorqueYAxisReader(int min, int max) : base(min, max) { }
      protected override int Read(ref JoystickState state) { return state.TorqueY; }
    }
    private class TorqueZAxisReader : AxisReader {
      public TorqueZAxisReader(int min, int max) : base(min, max) { }
      protected override int Read(ref JoystickState state) { return state.TorqueZ; }
    }
