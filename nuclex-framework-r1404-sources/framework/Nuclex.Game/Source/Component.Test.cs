  ...
  internal class ComponentTest {
    ...
    public void TestUpdateOrderChangeEvent() {
      ...
      mockedSubscriber.Expects.One.Method(
        m => m.UpdateOrderChanged(null, null)
      ).WithAnyArguments();
      testComponent.UpdateOrder = 123;
    ...
    public void TestEnabledChangeEvent() {
      ...
      mockedSubscriber.Expects.One.Method(m => m.EnabledChanged(null, null)).WithAnyArguments();
      testComponent.Enabled = false;
      this.mockery.VerifyAllExpectationsHaveBeenMet();
    }
    ...
    private Mock<IComponentSubscriber> mockSubscriber(Component component) {
      Mock<IComponentSubscriber> mockedSubscriber =
        this.mockery.CreateMock<IComponentSubscriber>();

      component.EnabledChanged += new DeviceEventHandler(
        mockedSubscriber.MockObject.EnabledChanged
      );
      component.UpdateOrderChanged += new DeviceEventHandler(
        mockedSubscriber.MockObject.UpdateOrderChanged
      );
