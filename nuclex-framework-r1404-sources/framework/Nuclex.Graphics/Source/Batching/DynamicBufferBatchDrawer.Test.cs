    ...
    private class Creator : IDisposable {
      ...
      public Creator() {
        ...
        try {
          ...
          this.batchDrawer = new DynamicBufferBatchDrawer<TestVertex>(
      ...
      public DynamicBufferBatchDrawer<TestVertex> BatchDrawer {
      ...
      private DynamicBufferBatchDrawer<TestVertex> batchDrawer;
