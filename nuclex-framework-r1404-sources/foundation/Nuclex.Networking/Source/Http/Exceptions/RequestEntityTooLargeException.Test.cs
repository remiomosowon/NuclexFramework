...
namespace Nuclex.Networking.Http.Exceptions {
  ...
  public class RequestEntityTooLargeExceptionTest {
    ...
    public void TestDefaultConstructor() {
      RequestEntityTooLargeException testException = new RequestEntityTooLargeException();
    ...
    public void TestSerialization() {
      ...
      using(MemoryStream memory = new MemoryStream()) {
        RequestEntityTooLargeException exception1 = new RequestEntityTooLargeException(
          "Hello World"
        );
        ...
        Assert.IsInstanceOf<RequestEntityTooLargeException>(exception2);
        Assert.AreEqual(
          exception1.Message, ((RequestEntityTooLargeException)exception2).Message
        );
      }
    }
