...
namespace Nuclex.Networking.Http.Exceptions {
  ...
  public class RequestEntityTooLargeException : HttpException {
    ...
    public RequestEntityTooLargeException() :
      base(StatusCode.S413_Request_Entity_Too_Large, "Request Entity Too Large") { }

    /// <summary>Initializes the exception with an error message</summary>
    /// <param name="message">Error message describing the cause of the exception</param>
    public RequestEntityTooLargeException(string message) :
      base(StatusCode.S413_Request_Entity_Too_Large, message) { }
    ...
    public RequestEntityTooLargeException(string message, Exception inner) :
      base(StatusCode.S413_Request_Entity_Too_Large, message, inner) { }

    /// <summary>Initializes the exception from its serialized state</summary>
    /// <param name="info">Contains the serialized fields of the exception</param>
    /// <param name="context">Additional environmental informations</param>
    protected RequestEntityTooLargeException(
