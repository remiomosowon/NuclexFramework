...
namespace Nuclex.Audio.Metadata.Exceptions {
  ...
  [TestFixture]
  public class DatabaseEntryCorruptExceptionTest {
    ...
    public void TestDefaultConstructor() {
      DatabaseEntryCorruptException testException = new DatabaseEntryCorruptException();
    ...
    public void TestSerialization() {
      ...
      using(MemoryStream memory = new MemoryStream()) {
        DatabaseEntryCorruptException exception1 = new DatabaseEntryCorruptException(
          "Hello World"
        );
        ...
        Assert.IsInstanceOf<DatabaseEntryCorruptException>(exception2);
        Assert.AreEqual(
          exception1.Message, ((DatabaseEntryCorruptException)exception2).Message
        );
      }
    }
