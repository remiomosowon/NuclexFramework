...
namespace Nuclex.Audio.Metadata.Exceptions {
  ...
  [TestFixture]
  public class TooManyUsersExceptionTest {
    ...
    public void TestDefaultConstructor() {
      TooManyUsersException testException = new TooManyUsersException();
    ...
    public void TestSerialization() {
      ...
      using(MemoryStream memory = new MemoryStream()) {
        TooManyUsersException exception1 = new TooManyUsersException(
          "Hello World"
        );
        ...
        Assert.IsInstanceOf<TooManyUsersException>(exception2);
        Assert.AreEqual(
          exception1.Message, ((TooManyUsersException)exception2).Message
        );
      }
    }
