...
namespace Nuclex.Audio.Metadata.Exceptions {
  ...
  public class EntryNotFoundExceptionTest {
    ...
    public void TestDefaultConstructor() {
      EntryNotFoundException testException = new EntryNotFoundException();
    ...
    public void TestSerialization() {
      ...
      using(MemoryStream memory = new MemoryStream()) {
        EntryNotFoundException exception1 = new EntryNotFoundException(
          "Hello World"
        );
        ...
        Assert.IsInstanceOf<EntryNotFoundException>(exception2);
        Assert.AreEqual(
          exception1.Message, ((EntryNotFoundException)exception2).Message
        );
      }
    }
