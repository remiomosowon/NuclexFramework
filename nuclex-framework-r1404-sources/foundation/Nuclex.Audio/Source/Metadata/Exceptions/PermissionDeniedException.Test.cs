...
namespace Nuclex.Audio.Metadata.Exceptions {
  ...
  public class PermissionDeniedExceptionTest {
    ...
    public void TestDefaultConstructor() {
      PermissionDeniedException testException = new PermissionDeniedException();
    ...
    public void TestSerialization() {
      ...
      using(MemoryStream memory = new MemoryStream()) {
        PermissionDeniedException exception1 = new PermissionDeniedException(
          "Hello World"
        );
        ...
        Assert.IsInstanceOf<PermissionDeniedException>(exception2);
        Assert.AreEqual(
          exception1.Message, ((PermissionDeniedException)exception2).Message
        );
      }
    }
