...
namespace Nuclex.Math.Generic {
  ...
  public partial struct UncheckedScalarMath :
    ...
    [DebuggerStepThrough]
    int IDoubleConversionProvider<int>.FromDouble(double value) {
    ...
    int ITrigonometricsProvider<int>.Sin(double angle) {
      unchecked { return (int)System.Math.Sin(angle); }
    }
    ...
    int ITrigonometricsProvider<int>.Cos(double angle) {
      unchecked { return (int)System.Math.Cos(angle); }
    }
    ...
    int ITrigonometricsProvider<int>.Asin(double angle) {
      unchecked { return (int)System.Math.Asin(angle); }
    }
    ...
    int ITrigonometricsProvider<int>.Acos(double angle) {
      unchecked { return (int)System.Math.Acos(angle); }
    }
    ...
    int ITrigonometricsProvider<int>.Tan(int value) {
      unchecked { return (int)System.Math.Tan(value); }
    }
    ...
    int ITrigonometricsProvider<int>.Atan(int value) {
      unchecked { return (int)System.Math.Atan(value); }
    }
    ...
    [DebuggerStepThrough]
    public int Scale(int number, double factor) {
      unchecked { return (int)(number * factor); }
    }
    ...
    [DebuggerStepThrough]
    public int Unscale(int number, double divisor) {
      unchecked { return (int)(number / divisor); }
    }
    ...
    [DebuggerStepThrough]
    public int Subtract(int number, int subtrahend) {
    ...
    public int Pow(int number, int power) {
      unchecked { return (int)System.Math.Pow(number, power); }
    }
    ...
    public int Sqrt(int number) {
      unchecked { return (int)System.Math.Sqrt(number); }
    }
    ...
    public int Log(int number) {
      unchecked { return (int)System.Math.Log(number); }
    }
    ...
    [DebuggerStepThrough]
    public int Exp(int number) {
      unchecked { return (int)System.Math.Exp(number); }
    }
