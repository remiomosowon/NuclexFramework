...
namespace Nuclex.Math.Generic {
  ...
  public partial struct CheckedScalarMath :
    ...
    [DebuggerStepThrough]
    float IDoubleConversionProvider<float>.FromDouble(double value) { return (float)value; }
    ...
    [DebuggerStepThrough]
    double IDoubleConversionProvider<float>.ToDouble(float value) { return value; }
    ...
    [DebuggerStepThrough]
    public float Scale(float number, double factor) { return (float)(number * factor); }
    ...
    [DebuggerStepThrough]
    public float Unscale(float number, double divisor) { return (float)(number / divisor); }
    ...
    [DebuggerStepThrough]
    public float Abs(float number) { return System.Math.Abs(number); }
    ...
    [DebuggerStepThrough]
    public float Subtract(float number, float subtrahend) { return number - subtrahend; }
    ...
    [DebuggerStepThrough]
    public float Multiply(float number, float factor) { return number * factor; }
    ...
    [DebuggerStepThrough]
    public float Divide(float number, float divisor) { return number / divisor; }
    ...
    public float Exp(float number) {
      return (float)System.Math.Exp(number);
    }
