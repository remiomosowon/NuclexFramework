...
namespace Nuclex.Math.Generic {
  ...
  public partial struct CheckedScalarMath :
    ...
    [DebuggerStepThrough]
    public double Scale(double number, double factor) { return number * factor; }
    ...
    [DebuggerStepThrough]
    public double Unscale(double number, double divisor) { return number / divisor; }
    ...
    [DebuggerStepThrough]
    public double Abs(double number) { return System.Math.Abs(number); }
    ...
    [DebuggerStepThrough]
    public double Subtract(double number, double subtrahend) { return number - subtrahend; }
    ...
    [DebuggerStepThrough]
    public double Multiply(double number, double factor) { return number * factor; }
    ...
    [DebuggerStepThrough]
    public double Divide(double number, double divisor) { return number / divisor; }
